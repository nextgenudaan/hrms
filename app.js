...
// Sample demo data for initial seeding
...
function checkAuthState() {
  const isLoggedIn = sessionStorage.getItem('hrms_logged_in');
  if (isLoggedIn) {
    showDashboard();
  } else {
    showLogin();
...
function validateForm() {
  const requiredFields = ['empCode', 'fullName', 'fatherName', 'dob', 'doj', 'status', 'mobile', 'email', 'empPassword', 'location', 'designation'];
  ...
  if (!emailPattern.test(formFields.email.value)) {
