...
const formFields = {
  ...
  EMPEMAILID: document.getElementById('EMPEMAILID'), // Unified as EMPEMAILID to match HTML
...
function handleFormSubmit(event) {
  ...
  const employeeData = {
    ...
    email: formFields.EMPEMAILID.value.trim().toLowerCase(), // Use EMPEMAILID from formFields
...
function validateForm() {
  const requiredFields = [
    ...
    { field: formFields.EMPEMAILID, name: 'Email' }, // Use EMPEMAILID
  ...
  if (!emailPattern.test(formFields.EMPEMAILID.value.trim())) { // Use EMPEMAILID
    showToast('Please enter a valid email address', 'error');
    formFields.EMPEMAILID.focus(); // Use EMPEMAILID
    return false;
  }
...
function editEmployee(id) {
  ...
  Object.keys(formFields).forEach(key => {
    ...
    // Handle special case where 'EMPEMAILID' in form maps to 'email' in employee object
    if (key === 'EMPEMAILID') {
